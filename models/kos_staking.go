...
type StakingSubpool struct {
	...
	StakedKeychainID         int                      `bson:"stakedKeychains,omitempty"`         // the keychain staked in this subpool
	StakedSuperiorKeychainID int                      `bson:"stakedSuperiorKeychains,omitempty"` // the superior keychain staked in this subpool
...
type Staker struct {
	...
	TotalPools         []*primitive.ObjectID `bson:"totalPools,omitempty"`      // the total pools the staker has staked in
	TotalSubpools      []*primitive.ObjectID `bson:"totalSubpools,omitempty"`   // the total subpools the staker has staked in. Note: the amount of subpools will always be greater than or equal to the amount of pools staked in.
